...
import com.github.chen0040.tflite.classifiers.InputStreamUtils;
import com.github.chen0040.tflite.classifiers.ResourceUtils;
import com.github.chen0040.tflite.classifiers.TensorUtils;
...
public class Cifar10ImageClassifier implements AutoCloseable {
    ...
    public String predict_image(BufferedImage image) {
        return predict_image(image, image.getWidth(), image.getHeight());
    }
